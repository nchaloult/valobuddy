# Generated by Fly.io's boilerplate for Laravel applications.
#
# Ran `$ fly launch`, let it create new files in this project, and then
# I manually tore down all the infrastructure it stood up.
